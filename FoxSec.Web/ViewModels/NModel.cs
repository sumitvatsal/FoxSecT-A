...
namespace FoxSec.Web.ViewModels
{
    ...
    //    {
    //        const string NorthwindDataContextKey = "FoxSecDBContext";
    //        public static FoxSecDBContext DB
    //        {
    //            get
    //            {
    //                if (HttpContext.Current.Items[NorthwindDataContextKey] == null)
    //                    HttpContext.Current.Items[NorthwindDataContextKey] = new FoxSecDBContext();
    //                return (FoxSecDBContext)HttpContext.Current.Items[NorthwindDataContextKey];
    //            }
    //        }
