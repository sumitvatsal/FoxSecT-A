   ...
   public class Encryption
    {
        ...
        public static string Encrypt11(string input)
        {
        ...
        public static string Decrypt11(string input)
        {
        ...
        public static string decrypt1(string message)
        {
            byte[] results;
            UTF8Encoding utf8 = new UTF8Encoding();
            MD5CryptoServiceProvider md5 = new MD5CryptoServiceProvider();
            byte[] deskey = md5.ComputeHash(utf8.GetBytes(ENCRYPTION_KEY));
        ...
        /// <returns></returns>
        public static string Decrypt(string cipherString, bool useHashing,string encryptkey)
        {
            byte[] keyArray;
