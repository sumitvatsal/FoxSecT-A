...
<tr>
    ...
    <td style='width: 30%;'>
                <div id='locPrintControlButtons' style="display:none; text-align:right">
	...
	<td style='width: 4%; vertical-align: top; padding-top: 20px;'>
		<span id='button_submit_loc_search' class='icon icon_find tipsy_we' title='Search users!' onclick="javascript:SubmitlocSearch();"></span>
	</td>
</tr>
</table>
</form>
<div id='AreaLocSearchResultsWait' style='display: none; width: 100%; height:620px; text-align:center'><span style='position:relative; top:40%' class='icon loader'></span></div>
<div id='ArealocSearchResults' style='display: none; margin: 15px 0;'></div>
...
<script type="text/javascript" lang="javascript">
    ...
    function SubmitLocSearch() {
        $.ajax({
            ...
            beforeSend: function () {
                $("#button_submit_loc_search").addClass("Trans");
                $("div#AreaLocSearchResults").fadeOut('fast', function () { $("div#AreaLocSearchResultsWait").fadeIn('slow'); });
            },
            success: function (result) {
                $("div#AreaLocSearchResultsWait").hide();
                $("div#AreaLocSearchResults").html(result);
                $("div#AreaLocSearchResults").fadeIn('fast');
                $("#button_submit_loc_search").removeClass("Trans");
            }
        });
        return false;
    }
