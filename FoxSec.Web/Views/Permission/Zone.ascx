...
<table id="permissionTimeZoneTable_<%= Model.TimeZoneId %>_<%= Model.OrderInGroup %>" cellpadding="0" cellspacing="0" style="margin: 0; width: 130px; min-width: 130px; border-spacing: 0; text-align: center">
<tr>
...
<tr>
<td colspan="7"><span id='permissionTimeZoneTime_<%= Model.Id %>_<%= Model.ValidFromStr %>'><%= Model.ValidFromStr %></span> - <%= Model.ValidToStr %></td>
</tr>
</table>