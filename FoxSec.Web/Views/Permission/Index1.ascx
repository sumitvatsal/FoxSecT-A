...
<input type='button' id='button_save_permission_group' value='<%=ViewResources.SharedStrings.BtnSaveChanges %>' style="display:none" onclick="javascript:SavePermissionGroup();" />
    <input type='button' id='button_change_object_time_zone' value='<%=ViewResources.SharedStrings.BtnNewDefaultTZ %>' style="display:none" onclick="javascript:SetTimeZoneToObject();" />
...
//            		});
    ...
    function GetZoneByObject(Id, isRoom) {
        ...
        $("input#button_change_object_time_zone").fadeIn();
        $("input#button_change_object_time_zone").val("Set TZ to Door");
