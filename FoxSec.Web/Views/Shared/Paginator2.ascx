...
<tr>
   ...
   <td>
    ...
    <td>
      ...
      <%--  <select id="lstVedioUser" onchange="UserssChangePage(1,this.value)">
...
<script type="text/javascript">
    ...
    function <%: Model.Prefix %>ChangePage(page,val) {
        
        Handle<%: Model.Prefix %>Paging(page, val);
        return false;
    } 
  ...
  <%--  function UserssChangePage(page,val)
    {
        
        
        Handle<%: Model.Prefix %>Paging(page, val);
        $("#lstVedioUser").val(val);
      //  return false;
    }
   <%-- function <%: Model.Prefix %>ChangePage(page) {
        alert($("#lstVedioUser").val());
        Handle<%: Model.Prefix %>Paging(page, $("#lstVedioUser").val());
        return false;
    }--%>
