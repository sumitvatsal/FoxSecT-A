...
<tr>
    <td style='padding:2px; text-align:right; vertical-align: top'>
        <select id="ListOfGroupsForUser" onchange="javascript:SelectUserPermissionGroup();" ></select>
        &nbsp; <input type='button' id='addPermissionToUser' value='<%=ViewResources.SharedStrings.CommonApplyChanges %>' style='font-size: 11px; display: none' onclick='javascript: SaveUserPermission();' />
        &nbsp; <input type='button' id='ButtonAdd' value='Add' style='font-size: 11px; display:none 'onclick='javascript: AddUserPermission();' />
         &nbsp; <input type='button' id='ButtonDel' value='Delete' style='font-size: 11px; display:none 'onclick='javascript: DelUserPermission();' />
         &nbsp; <input type='button' id='Button1' value='Clear Added' style='font-size: 11px; 'onclick='javascript: RenewPG();' />
    </td>
</tr>
<tr>
    <td style='padding:2px; text-align:right; vertical-align: top'>
        <%:ViewResources.SharedStrings.CommonTimeZoneName %>:<%= Html.TextBox("UserPermissionsTimeZoneSearchByName", "", new { @style = "width:180px" })%> &nbsp; <%=ViewResources.SharedStrings.CommonStartTime %>:<%= Html.TextBox("UserPermissionsTimeZoneSearchStartTime", "", new { @style = "width:74px" })%> <span id='button_submit_user_permission_time_zone_search' class='icon icon_find tipsy_we' original-title='Search time zone!' onclick="javascript:SubmitUserPermissionTimeZoneSearch();"></span>
    </td>
</tr>
<tr>
    <td style='width:100%; padding:2px;'><br /><div id='userPermissionTimeZoneList' style='display:none'></div></td>
</tr>
</table>
</div>
...
<script type="text/javascript" language="javascript">
    ...
    $(document).ready(function () {
        ...
        $("#ListOfGroupsForUser").select2({
            width: '22%',
            dropdownParent: $("#panel_edit_user")
