...
<div id="content_edit_card_type" style='margin:10px; text-align:center; display:none' >
<form id="editCardType" action="">
<%=Html.Hidden("CardType.Id", Model.CardType.Id) %>
<table width="100%">
    <tr>
    ...
    <tr>
		...
		<td style='width:70%; padding:0 5px;'><%=Html.CheckBox("CardType.IsCardCode", Model.CardType.IsCardCode )%></td>
    </tr>
    <tr>
		...
		<td style='width:70%; padding:0 5px;'><%=Html.CheckBox("CardType.IsSerDK", Model.CardType.IsSerDK)%></td>
    </tr>
</table>
</form>

<script type="text/javascript" language="javascript">
    $("div#content_edit_card_type").fadeIn("300");
</script>
